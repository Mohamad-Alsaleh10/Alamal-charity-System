                    ...
                    <div class="row">
                        <div class="col-md-6 border-right-2 border-right-blue-400">
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label font-weight-semibold">اسم الجمعية<span class="text-danger">*</span></label>
                                <div class="col-lg-9">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label font-weight-semibold">اسم الجمعية المختصر</label>
                                <div class="col-lg-9">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label font-weight-semibold">عنوان الجمعية<span class="text-danger">*</span></label>
                                <div class="col-lg-9">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label font-weight-semibold">شعار الجمعية</label>
                                <div class="col-lg-9">
                                    <div class="mb-3">
